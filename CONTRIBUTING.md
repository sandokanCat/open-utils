...
Thank you for your interest in contributing to `open-utils`! 🎉
...
3. **Make your changes** following the code style (see [`AGENTS.md`](./AGENTS.md) or existing files).
4. **Commit**: Write clear and concise messages.
